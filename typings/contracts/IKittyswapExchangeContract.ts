...
import { IKittyswapsExchange } from "./IKittyswapsExchange";

export class IKittyswapsExchangeFactory {
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IKittyswapsExchange {
    return new Contract(address, _abi, signerOrProvider) as IKittyswapsExchange;
  }
}
