...
interface IKittyswapsExchangeInterface extends ethers.utils.Interface {
  functions: {
...
export class IKittyswapsExchange extends Contract {
  ...
  interface: IKittyswapsExchangeInterface;
