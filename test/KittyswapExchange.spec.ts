...
describe('KittyswapsExchange', () => {
  ...
  let operatorExchangeContract: KittyswapsExchange
  ...
  conditions.forEach(function(condition) {
    context(condition[0] as string, () => {
      ...
      beforeEach(async () => {
        ...
        kittyswapsExchangeContract = new ethers.Contract(exchangeAddress, exchangeABI, ownerWallet) as KittyswapsExchange
        operatorExchangeContract = kittyswapsExchangeContract.connect(operatorSigner) as KittyswapsExchange
      ...
      describe('Getter functions', () => {
        describe('getTokenAddress() function', () => {
          it('should return token address', async () => {
            const token_address = await kittyswapsExchangeContract.functions.getTokenAddress()
        ...
        describe('getCurrencyInfo() function', () => {
          it('should return currency token address and ID', async () => {
            const token_info = await kittyswapsExchangeContract.functions.getCurrencyInfo()
        ...
        describe('getBuyPrice() function', () => {
          it('should round UP', async () => {
            ...
            let numerator = 1500
            let denominator = 751
            const price = await kittyswapsExchangeContract.functions.getBuyPrice(bought_amount, numerator, denominator)
        ...
        describe('getSellPrice() function', () => {
          it('should round DOWN', async () => {
            ...
            let denominator = 751
            let bought_amount = 100
            const price = await kittyswapsExchangeContract.functions.getSellPrice(bought_amount, denominator, numerator)
        ...
        describe('getFactoryAddress() function', () => {
          it('should return factory address', async () => {
            const factory_address = await kittyswapsExchangeContract.functions.getFactoryAddress()
            await expect(factory_address[0]).to.be.eql(kittyswapsFactoryContract.address)
          })
        })

        describe('supportsInterface()', () => {
          it('should return true for 0x01ffc9a7 (IERC165)', async () => {
            const support = await kittyswapsExchangeContract.functions.supportsInterface('0x01ffc9a7')
            expect(support[0]).to.be.eql(true)
          })
    
          it('should return true for 0x4e2312e0 (IERC1155Receiver)', async () => {
            const support = await kittyswapsExchangeContract.functions.supportsInterface('0x4e2312e0')
            expect(support[0]).to.be.eql(true)
          })
  
          it('should return true for 0xd9b67a26 (IERC1155)', async () => {
            const support = await kittyswapsExchangeContract.functions.supportsInterface('0xd9b67a26')
            expect(support[0]).to.be.eql(true)
          })
        })
      })
      ...
      describe('_addLiquidity() function', () => {
        ...
        it('should pass when balances are sufficient', async () => {
          const tx = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd, addLiquidityData,
            {gasLimit: 50000000}
          )
        ...
        it('should ROUND UP the currency amount to be deposited on second deposit', async () => {
          ...
          // After 2nd deposit
          await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0], tokenAmountsToAdd1, addLiquidityData1,
            {gasLimit: 50000000}
          )

          let reserve1 = (await kittyswapsExchangeContract.functions.getCurrencyReserves([0]))[0]
          ...
          // After 2nd deposit
          await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0], tokenAmountsToAdd2, addLiquidityData2,
            {gasLimit: 50000000}
          )

          let reserve2 = (await kittyswapsExchangeContract.functions.getCurrencyReserves([0]))[0]
        ...
        it('should ROUND DOWN the amount of liquidity to mint on second deposit', async () => {
          ...
          let liquidity_supply1 = (await kittyswapsExchangeContract.functions.getTotalSupply([0]))[0]
          ...
          let liquidity_supply2 = (await kittyswapsExchangeContract.functions.getTotalSupply([0]))[0]
        ...
        it('should REVERT if trying to crease currency/currency pool', async () => {
          ...
          // Retrieve exchange address
          let exchangeAddress2 = await kittyswapsFactoryContract.functions.tokensToExchange(ownerERC1155Contract.address, ownerERC1155Contract.address, types[0])
          ...
          await expect(tx).to.be.rejectedWith(RevertError("KittyswapsExchange#_addLiquidity: CURRENCY_POOL_FORBIDDEN"))
        })
        ...
        it('should REVERT if deadline is passed', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_addLiquidity: DEADLINE_EXCEEDED") )
        })
        ...
        it('should REVERT if a maxCurrency is null', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_addLiquidity: NULL_MAX_CURRENCY") )
        })
        ...
        it('should REVERT if a token amount is null', async () => {
          ...
          const tx = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAddCopy, addLiquidityData,
            {gasLimit: 8000000}
          )
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_addLiquidity: NULL_TOKENS_AMOUNT") )
        })
        ...
        it('should REVERT if arrays are not the same length', async () => {
          ...
          const tx1 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [1, 1], data, TX_PARAM)
          ...
          const tx2 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1, 2], [1, 1, 1], data, TX_PARAM)
          await expect(tx2).to.be.rejectedWith(RevertError())
          
          data = getAddLiquidityData([currencyAmount1, currencyAmount1], deadline)
          const tx3 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [1, 1, 1], data, TX_PARAM)
          ...
          const tx4 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [1], data, TX_PARAM)
          await expect(tx4).to.be.rejectedWith(RevertError(erc1155_error_prefix + "_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

          data = getAddLiquidityData([currencyAmount1, currencyAmount1], deadline)
          const tx5 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [1], data, TX_PARAM)
          await expect(tx5).to.be.rejectedWith(RevertError(erc1155_error_prefix + "_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

          data = getAddLiquidityData([currencyAmount1], deadline)
          const tx6 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [1, 1], data, TX_PARAM)
          await expect(tx6).to.be.rejectedWith(RevertError())
        })

        it('should REVERT if any duplicate', async () => {
          const tx1 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 1], [tokenAmountToAdd, tokenAmountToAdd], addLiquidityData,
            {gasLimit: 50000000}
          )
          await expect(tx1).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )

          const tx2 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 2, 2], [tokenAmountToAdd, tokenAmountToAdd, tokenAmountToAdd], addLiquidityData,
            {gasLimit: 50000000}
          )
          await expect(tx2).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )

          const tx3 = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 2, 1], [tokenAmountToAdd, tokenAmountToAdd, tokenAmountToAdd], addLiquidityData,
            {gasLimit: 50000000}
          )
          await expect(tx3).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
        })
        ...
        context('When liquidity was added', () => {
          ...
          beforeEach( async () => {
            tx = await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd, addLiquidityData,
              {gasLimit: 50000000}
            )
          })
          ...
          it('should update currency balances', async () => {
              const exchangeBalance = await userCurrencyContract.functions.balanceOf(kittyswapsExchangeContract.address, currencyID)
          ...
          it('should update the currency per token reserve', async () => {
            for (let i = 0; i < types.length; i++) {
              const reserve = await kittyswapsExchangeContract.functions.getCurrencyReserves([types[i]])
          ...
          it('should update total supplies for Kittyswaps Token ids balances', async () => {
            const exchangeTotalSupplies = await kittyswapsExchangeContract.functions.getTotalSupply(types)
            for (let i = 0; i < types.length; i++) {
          ...
          it('should DECREASE the BUY prices for 2ND deposit', async () => {
            ...
            // After 1st deposit
            const prePrices = await kittyswapsExchangeContract.functions.getPrice_currencyToToken(types, ones)

            // After 2nd deposit
            await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd, addLiquidityDataOne,
              {gasLimit: 50000000}
            )
            const postPrices = await kittyswapsExchangeContract.functions.getPrice_currencyToToken(types, ones)
          ...
          it('should INCREASE the SELL prices for 2ND deposit', async () => {
            ...
            // After 1st deposit
            const prePrices = await kittyswapsExchangeContract.functions.getPrice_tokenToCurrency(types, ones)

            // After 2nd deposit
            await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd, addLiquidityDataOne,
              {gasLimit: 50000000}
            )
            const postPrices = await kittyswapsExchangeContract.functions.getPrice_tokenToCurrency(types, ones)
          ...
          it('should emit LiquidityAdded event', async () => {
            ...
            filterFromOperatorContract = kittyswapsExchangeContract.filters.LiquidityAdded(null, null, null, null);
            ...
            expect(logs[0].topics[0]).to.be.eql(kittyswapsExchangeContract.interface.getEventTopic(kittyswapsExchangeContract.interface.events["LiquidityAdded(address,uint256[],uint256[],uint256[])"]))
          })
        ...
        context('When liquidity was added for the second time', () => {
          ...
          it('should REVERT if a maxCurrency is exceeded', async () => {
            ...
            await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_addLiquidity: MAX_CURRENCY_AMOUNT_EXCEEDED") )
          })
          ...
          it('should update total supples for Kittyswaps Token ids balances', async () => {
            for (let i = 0; i < types.length; i++) {
              const exchangeTotalSupply = await kittyswapsExchangeContract.functions.getTotalSupply([types[i]])
              const newCurrencyAmount = (tokenAmountToAdd.mul(currencyAmountToAdd)).div(tokenAmountToAdd)
        ...
        describe('When liquidity > 0', () => {
          ...
          it('should pass when balances are sufficient', async () => {
            ...
            const tx = operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd, addLiquidityData2,
              {gasLimit: 8000000}
            )
            await expect(tx).to.be.fulfilled
          })
      ...
      describe('_removeLiquidity() function', () => {
        ...
        it('should revert if no Kittyswaps token', async () => {
          const tx = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, niftyTokenToSend, removeLiquidityData,
            {gasLimit: 8000000}
          )
        ...
        it('should revert if empty reserve', async () => {
          ...
          const tx = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, zeroArray, removeLiquidityData,
            {gasLimit: 8000000}
          )
          await expect(tx).to.be.rejectedWith(RevertError("KittyswapsExchange#_removeLiquidity: NULL_TOTAL_LIQUIDITY"))
        })


        context('When liquidity was added', () => {
          beforeEach( async () => {
            await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, tokenAmountsToAdd, addLiquidityData,
              {gasLimit: 50000000}
            )
          })
          ...
          it('should revert if insufficient currency', async () => {
            ...
            await expect(tx).to.be.rejectedWith(RevertError("KittyswapsExchange#_removeLiquidity: INSUFFICIENT_CURRENCY_AMOUNT"))
          })
          ...
          it('should revert if insufficient tokens', async () => {
            ...
            await expect(tx).to.be.rejectedWith(RevertError("KittyswapsExchange#_removeLiquidity: INSUFFICIENT_TOKENS"))
          })

          it('should fail if any duplicate', async () => {
            const tx1 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 1], [currencyAmountToRemove, currencyAmountToRemove], removeLiquidityData,
              {gasLimit: 8000000}
            )
            await expect(tx1).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
      
            const tx2 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 2, 2], [currencyAmountToRemove, currencyAmountToRemove, currencyAmountToRemove], removeLiquidityData,
              {gasLimit: 8000000}
            )
            await expect(tx2).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
      
            const tx3 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [1, 2, 1], [currencyAmountToRemove, currencyAmountToRemove, currencyAmountToRemove], removeLiquidityData,
              {gasLimit: 8000000}
            )
            await expect(tx3).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
          })
          ...
          it('should REVERT if arrays are not the same length', async () => {  
            ...
            const tx1 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [0, 1], [currencyAmountToRemove], data, TX_PARAM)
            ...
            const tx2 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [2], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            ...
            const tx3 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [3], [currencyAmountToRemove], data, TX_PARAM)
            ...
            const tx4 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [4], [currencyAmountToRemove], data, TX_PARAM)
            await expect(tx4).to.be.fulfilled

            data = getRemoveLiquidityData([currencyAmountToRemove], [tokenAmountToRemove], deadline)
            const tx5 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [5, 6], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            await expect(tx5).to.be.rejectedWith(RevertError())

            data = getRemoveLiquidityData([currencyAmountToRemove, currencyAmountToRemove], [tokenAmountToRemove], deadline)
            const tx6 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [7, 8], [currencyAmountToRemove], data, TX_PARAM)
            ...
            const tx7 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [9, 10], [currencyAmountToRemove], data, TX_PARAM)
            await expect(tx7).to.be.rejectedWith(RevertError("ERC1155#_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

            data = getRemoveLiquidityData([currencyAmountToRemove, currencyAmountToRemove], [tokenAmountToRemove], deadline)
            const tx8 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [11], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            await expect(tx8).to.be.rejectedWith(RevertError("ERC1155#_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

            data = getRemoveLiquidityData([currencyAmountToRemove], [tokenAmountToRemove, tokenAmountToRemove], deadline)
            const tx9 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [12], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            ...
            const tx10 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [13], [currencyAmountToRemove], data, TX_PARAM)
            await expect(tx10).to.be.fulfilled

            data = getRemoveLiquidityData([currencyAmountToRemove, currencyAmountToRemove], [tokenAmountToRemove], deadline)
            const tx11 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [14, 15], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            await expect(tx11).to.be.rejectedWith(RevertError())

            data = getRemoveLiquidityData([currencyAmountToRemove], [tokenAmountToRemove, tokenAmountToRemove], deadline)
            const tx12 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [16, 17], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            await expect(tx12).to.be.rejectedWith(RevertError())

            data = getRemoveLiquidityData([currencyAmountToRemove, currencyAmountToRemove], [tokenAmountToRemove, tokenAmountToRemove], deadline)
            const tx13 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [18, 19], [currencyAmountToRemove], data, TX_PARAM)
            await expect(tx13).to.be.rejectedWith(RevertError("ERC1155#_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

            data = getRemoveLiquidityData([currencyAmountToRemove, currencyAmountToRemove], [tokenAmountToRemove, tokenAmountToRemove], deadline)
            const tx14 = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, [20], [currencyAmountToRemove, currencyAmountToRemove], data, TX_PARAM)
            await expect(tx14).to.be.rejectedWith(RevertError("ERC1155#_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))
          })

          it('should PASS if enough Kittyswaps token', async () => {
            const tx = operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, niftyTokenToSend, removeLiquidityData,
              {gasLimit: 8000000}
            )
            await expect(tx).to.be.fulfilled
          ...
          it('should INCREASE the BUY prices for 2ND withdraw', async () => {
            ...
            // After 2nd deposit
            await operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, niftyTokenToSend, removeLiquidityData,
              {gasLimit: 8000000}
            )
            const postPrices = await kittyswapsExchangeContract.functions.getPrice_currencyToToken(types, ones)
          ...
          context('When liquidity was removed', () => {
            let tx;
            beforeEach( async () => {
              tx = await operatorExchangeContract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, typesToRemove, niftyTokenToSend, removeLiquidityData,
                {gasLimit: 8000000}
              )
            })
            ...
            it('should update the currency amount per token reserve', async () => {
              ...
              const reserves = await kittyswapsExchangeContract.functions.getCurrencyReserves(types)
              for (let i = 0; i < types.length; i++) {
      ...
      describe('_tokenToCurrency() function', () => {
        ...
        it('should fail if token balance is insufficient', async () => {
          ...
          const tx = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, types, tokensAmountsToSell, sellTokenData,
            {gasLimit: 8000000}
          )
          if (condition[1] == 1 || condition[1] == 3){
            await expect(tx).to.be.rejectedWith( RevertError("SafeMath#sub: UNDERFLOW") )
        ...
        it('should fail if token sent is 0', async () => {
          ...
          const tx = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, types, tokensAmountsToSellCopy, sellTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_tokenToCurrency: NULL_TOKENS_SOLD") )
        })
        ...
        it('should fail if deadline is passed', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_tokenToCurrency: DEADLINE_EXCEEDED") )
        })
        ...
        it('should fail if currency balance is lower than cost', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_tokenToCurrency: INSUFFICIENT_CURRENCY_AMOUNT") )
        })

        it('should fail if any duplicate', async () => {
          const tx1 = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, [1, 1], [tokenAmountToSell, tokenAmountToSell], sellTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx1).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )

          const tx2 = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, [1, 2, 2], [tokenAmountToSell, tokenAmountToSell, tokenAmountToSell], sellTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx2).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )

          const tx3 = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, [1, 2, 1], [tokenAmountToSell, tokenAmountToSell, tokenAmountToSell], sellTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx3).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
        })
        ...
        it('should REVERT if arrays are not the same length', async () => {
          const tx1 = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, [0, 1], [tokenAmountToSell], sellTokenData, TX_PARAM)
          await expect(tx1).to.be.rejectedWith(RevertError(erc1155_error_prefix + "_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))

          const tx2 = userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, [0], [tokenAmountToSell, tokenAmountToSell], sellTokenData, TX_PARAM)
        ...
        describe('When trade is successful', async () => {
          ...
          beforeEach(async () => {
            ...
            tx = await userERC1155Contract.functions.safeBatchTransferFrom(userAddress, kittyswapsExchangeContract.address, types, tokensAmountsToSell, sellTokenData,
              {gasLimit: 8000000}
            )
          })
          ...
          it('should emit CurrencyPurchase event', async () => {
            ...
            // Get event filter to get internal tx event
            filterFromOperatorContract = kittyswapsExchangeContract.filters.CurrencyPurchase(null, null, null, null, null);
            ...
            expect(logs[0].topics[0]).to.be.eql(
              kittyswapsExchangeContract.interface.getEventTopic(
                kittyswapsExchangeContract.interface.events[
      ...
      describe('_currencyToToken() function', () => {
        ...
        it('should fail if currency sent is 0', async () => {
          const tx = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, 0, buyTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx).to.be.rejectedWith( RevertError("SafeMath#sub: UNDERFLOW") )
        })
        ...
        it('should fail if a bought amount is 0', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_currencyToToken: NULL_TOKENS_BOUGHT") )
        })
        ...
        it('should fail if deadline is passed', async () => {
          ...
          await expect(tx).to.be.rejectedWith( RevertError("KittyswapsExchange#_currencyToToken: DEADLINE_EXCEEDED") )
        })

        it('should fail if currency sent is lower than cost', async () => {
          const tx = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost.sub(1), buyTokenData,
            {gasLimit: 8000000}
          )
          await expect(tx).to.be.rejectedWith( RevertError("SafeMath#sub: UNDERFLOW") )
        })
        ...
        it('should fail if any duplicate', async () => {
          ...
          const tx1 = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, invalid_buyTokenData1,
            {gasLimit: 8000000}
          )
          ...
          const tx2 = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, invalid_buyTokenData2,
            {gasLimit: 8000000}
          )
          await expect(tx2).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
          ...
          const tx3 = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, invalid_buyTokenData3,
            {gasLimit: 8000000}
          )
          await expect(tx3).to.be.rejectedWith( RevertError("KittyswapsExchange#_getTokenReserves: UNSORTED_OR_DUPLICATE_TOKEN_IDS") )
        })
        ...
        it('should REVERT if arrays are not the same length', async () => {
          ...
          const tx1 = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, data, TX_PARAM)
          ...
          const tx2 = userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, data, TX_PARAM)
          await expect(tx2).to.be.rejectedWith(RevertError(erc1155_error_prefix + "_safeBatchTransferFrom: INVALID_ARRAYS_LENGTH"))
        })
        ...
        describe('When trade is successful', async () => {
          ...
          beforeEach(async () => {
            tx = await userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, buyTokenData,
              {gasLimit: 8000000}
            )
          })
          ...
          it('should have token sell price adjusted', async () => {
            const price = (await kittyswapsExchangeContract.functions.getPrice_currencyToToken([0], [tokenAmountToBuy]))[0];
          ...
          it('should emit TokensPurchase event', async () => {
            ...
            // Get event filter to get internal tx event
            filterFromOperatorContract = kittyswapsExchangeContract.filters.TokensPurchase(null, null, null, null, null);
        ...
        it('should send to non msg.sender if specified', async () => {
          ...
          const exchangeCurrencyBalance = await userCurrencyContract.functions.balanceOf(kittyswapsExchangeContract.address, currencyID)
      ...
      describe('Edge cases', () => {
        ...
        it('Pool can not go to zero token in reserve', async () => {
          ...
          let tx = kittyswapsExchangeContract.functions.getPrice_currencyToToken([types[0]], [1])
        ...
        it('Pool stuck at 1 token can go back up to normal with loss', async () => {
          ...
          await operatorERC1155Contract.functions.safeBatchTransferFrom(operatorAddress, kittyswapsExchangeContract.address, types, tokenAmountsToAdd_1, addLiquidityData_1,
            {gasLimit: 50000000}
          )

          // Buy 31622 tokens, to leave a ratio of 10**18 : 1, testing with 1 pool
          let amount_to_buy = BigNumber.from(31622)
          let cost = (await kittyswapsExchangeContract.functions.getPrice_currencyToToken([types[0]], [amount_to_buy]))[0][0]
          let buyTokenData = getBuyTokenData(userAddress, [types[0]], [amount_to_buy], deadline)
          await userCurrencyContract.functions.safeTransferFrom(userAddress, kittyswapsExchangeContract.address, currencyID, cost, buyTokenData,
            {gasLimit: 8000000}
          )
          ...
          let currency_reserve = (await kittyswapsExchangeContract.functions.getCurrencyReserves([types[0]]))[0]
          let token_reserve = await userERC1155Contract.functions.balanceOf(kittyswapsExchangeContract.address, types[0])
